...
$resultat=mysqli_query($conn,"SELECT * from annoncecolis where idcolis='$n' AND numeroparticulier='$num'") ;
        	...
        	if((($AdresseArriveColis==$lieuArrTrajet)||($AdresseArriveColis==$arret1)||($AdresseArriveColis==$arret2) || ($AdresseArriveColis==$arret3)||($AdresseArriveColis==$arret4))&& (($AdresseDepartColis==$lieuDepTrajet)||($AdresseDepartColis==$arret1)||($AdresseDepartColis==$arret2)||($AdresseDepartColis==$arret3)||($AdresseDepartColis==$arret4)))
        	{
             ...
             <div class='flat-box'>
                        ...
                        <p class='title'> $trajet</p>
                           ...
                           <p class='feature-text'>Adresse de depart : <strong> $lieuDepTrajet</strong> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp adresse d'arrivèe : <strong> $lieuArrTrajet </strong> </p>
                       <p>  N°téléphone : $num &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp  &nbsp <strong> $pre </strong>   </p>
                <form method='POST' action='selectionnerTrajet.php?id=$id&d=$idTrajet'>
                 <input type='submit' value='Envoyer Demande' name='invitation' id='invitation'/> 
                 </form>      
                      <form method='POST' action='detail.php?id=$id&d=$idTrajet'>
               
                 <input type='submit'  value='Details du trajet' name='detail' id='detail'/>
                 </form>    
  ...
  if (isset($_POST["detail"]))
  {
        ...
        header("Location: detail.php?id=$id&d=$idTrajet");
 }       				
