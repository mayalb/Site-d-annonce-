   ...
   <header class="header dark-bg">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Détails colis</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Accueil(Transporteur)</a></li>
              <li><i class="icon_document_alt"></i><a>Détails colis</a></li>
            </ol>
          </div>
        </div>
...
<div class='modal-content'>
      <div class='modal-body'>
        <div class='col-lg-12 col-md-12 col-xs-12' style='padding-top: 20px;' >
                   <p>
                <i class='fa fa-info'></i>&nbsp &nbsp Description du colis : <strong>  $description</strong> 
            </p>
                        <p>
                <i class='fa fa-info'></i>&nbsp &nbsp Adresse de depart : <strong>  $ladressedepart</strong> 
            </p>
            <p>
              <i class='fa fa-map-marker' aria-hidden='true'></i>&nbsp &nbsp Adresse d'arrivée : <strong>  $adressearrive</strong> 
            </p>
            ...
            <p>
                <i class='fa fa-arrows-v' aria-hidden='true'></i>&nbsp &nbspLa taille du colis est : <strong>$taille</strong>  
            </p>
            <p>
               <i class='fa fa-balance-scale' aria-hidden='true'></i>&nbsp &nbsp Le poids du colis :<strong> $poids</strong> 
            </p>
            <p>
                <i class='fa fa-bullseye'></i>&nbsp &nbsp Demande spécial :<strong>   $demandespecial</strong>
            </p>
        </div>
      </div>
