...
<form name="formulaire" id="formulaire"  method="POST" onsubmit="return valider();" enctype="multipart/form-data" action="">
    <div class="container">
          ...
          <label class="control-label">Itineraire</label><br>
            <div class="col-md-6 col-xs-6 col-sm-6">
                <div class="form-group">     
                  ...
                  <input type="text" class="form-control" id="from" name="lieudepart">
                </div>
            </div>
           ...
           <div class="col-md-6 col-xs-6 col-sm-6">
              <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="to" name="lieuarrive">
              </div>
           </div>   
        ...
        <div class="row">
           <div class="col-md-12">
                ...
                <div class="form-group">    
                      ...
                      <strong id="aff" style="color: red;"> 0 km</strong>
                      <input type="text" class="form-control" id="distance" name="kilometre" value="0" style="display: none;">
                </div>
                </div>
           </div>
     </div>
      ...
      return ($id);
        ...
        if (isset($_POST["submit"]))
        {
          ...
          if($choix=="oui"){
           ...
           $sqll = "INSERT INTO annoncetrajet(matriculetrajet,matriculetransporteur,lieudepart,lieuarrive,matriculevoiture,taille,datedepart,dateretour,kilometre,regulier,frequencevoyage,jourdepart,moyentransport,poids)
                      VALUES ('".$numerotrajet."','".$num."','". $lieudepart."','".$lieuarrive."','".$matricule."','".$taille."','".$datedepart."','".$dateretour."','".$kilometre."','".$regulier."','".$frequence."','".$jourdepart."','".$moyen."','".$poid."')";
