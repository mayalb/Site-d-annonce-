                ...
                <div class='row'>
                     ...
                     <div class='col-md-6 col-xs-6'>
                       ...
                       <input   type='submit' name='detail' id='detail' class='boxdetail'  value='Detail du trajet' /> 
                          ...
                          <span> <A href='supprimer.php?id=$id' style='color:red;font-weight:bold'>&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbspSupprimer</A></span>
