...
<?php
          ...
          $res1=mysqli_query($conn,'SELECT * from annoncecolis');

        $i=1;
        while(($row=mysqli_fetch_assoc($res1)) && $i<7){
         if($row['supprimer']==0){
         $description=$row['description'];
              $lieudepart=$row['adressedepart'];
              $lieuarrive=$row['adressearrive'];
              $datedepart=$row['dateenvoie'];
              $datearrive=$row['datedepot'];
              $taille=$row['taille'];
              $poids=$row['poids'];
   ...
   <div class='col-lg-4 col-md-4 col-sm-12 col-xs-12'>
            ...
            <div class='info-box white-bg'>
                ...
                <div>
                <strong>  <p> Description du colis : <span style='color:#78b9eb'>$description</span></p></strong> 
                  <div class='row'> 

                 <div class='col-xs-6'>  
                 <button class='boxdetail'>Voir le profil</button>  
                 </div>
                 <div class='col-xs-6'>  
