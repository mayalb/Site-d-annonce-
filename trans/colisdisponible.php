  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Les Colis Disponibles </h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Accueil (utilisateur)/ </a> <i class="fa fa-cubes"></i><a>Colis Disponibles</a></li>
            </ol>
          </div>
        </div>
            ...
            <div class='info-box white-bg'>
                    ...
                    <strong>  <p> Adresse d'arrivée :  <span style='color:#78b9eb'>$ad2</span></p></strong> 
                       ...
                       <input type='submit' name='aller' id='aller'  value=$inv class='boxdetail'> 
                        ...
                        <form action='details-colis.php?id=$id' method='post'>
