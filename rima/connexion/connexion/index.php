...
<div class="col-sm-8 coll" style="margin-top: 150px;">
  ...
  <br>
  <button type="submit" name="submit" id="submit" class="btn  but" style="background-color:#27c997;color: #fff;font-weight: bold ">Se connecter</button>
  <br>
  <br>
