            ...
            <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                ...
                <div>
                  <h3>  $colis &nbsp &nbsp  $ps </h3>
                    ...
                    <strong>  <p>Description : <span style='color:#78b9eb'>$desc</span></p></strong> 
                    <strong>  <p>La taille : <span style='color:#78b9eb'>$taille</span></p></strong> 
                    <strong>  <p>Poid : <span style='color:#78b9eb'>$poi</span></p></strong> 
                    <strong>  <p> <span style='color:#78b9eb'>$dem</span></p></strong> 
