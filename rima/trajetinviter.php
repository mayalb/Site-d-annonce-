      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Accueil (utilisateur)/ </a> <i class="fa fa-road"></i><a>Mes Colis</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
...
echo ("
        ...
        <div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
            <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                ...
                <div>
                  <h3>  $colis &nbsp &nbsp  $ps </h3>
                    <strong>  <p>Adresse départ :  <span style='color:#78b9eb'>$adrde</span></p></strong>
                    <strong>  <p>adresse d'arrivée :  <span style='color:#78b9eb'>$adrarr</span></p></strong> 
                    
                    <strong>  <p> Numero de telephone : <span style='color:#78b9eb'>$num</span></p></strong> 
                    ...
                    <form method='POST' action=''>
                     ...
                     <br>
                      <div class='row' >
                          <div class='col-xs-6'>
                               <span>  <A href='accepter.php?idt=$idtrajet&idc=$get' style='color:#27c995;font-weight:bold'> accepter</A></span>
                          </div>
                          <div class='col-xs-6'>
                              <A href='refuserinv.php?idt=$idtrajet&idc=$get' style='color:red;font-weight:bold'> refuser</A>
                          </div>
                      </div>
