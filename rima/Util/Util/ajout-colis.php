    ...
    <!--sidebar end-->
     <section id="main-content">
      <section class="wrapper">
      	<form name="formulaire" id="formulaire"  method="POST" enctype="multipart/form-data" action="ajout-colis.php">
    <div class="container">
          ...
          <label class="control-label">Itineraire</label><br>
            <div class="col-md-6 col-xs-6 col-sm-6">
                <div class="form-group">     
                  ...
                  <input type="text" class="form-control" id="adrdepart" name="adrdepart">
                </div>
            </div>
           ...
           <div class="col-md-6 col-xs-6 col-sm-6">
              <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="adrarrive" name="adrarrive">
              </div>
           </div>   
        </div>
    </div>
    ...
    <hr>
     ...
     <hr>
							        ...
							        <div class="image-upload">
									  ...
									  <label for="ima">
									    <img src="img/add.png" style="width: 60px;height: 60px;"/>
									  </label>
